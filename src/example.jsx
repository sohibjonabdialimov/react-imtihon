...
export const Form = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      name: Yup.string().min(3, "Kamida 3ta bo'lishi kerak!!!")
      .max(50, "Ko'pida 50 ta bo'lishi kerak!!!").required("Required"),
    }),
    onSubmit: (values) => {
  ...
  const editHandle = (e) => {
    ...
    if (
      ...
      axios
        ...
        .catch((err) => alert("404 not found error!!!"));
    } else {
      alert("Please, fill input fields!!!");
    }
  };
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="input__wrap">
          ...
          <input onChange={formik.handleChange}
            ...
            value={formik.values.name} ref={nameRef} type="text" id="name" />
